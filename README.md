...
Take care with the version in **React > 18.2.0 and NodeJS > 18.15.0**.\
// Cuando vuelves atras despues de haber buscado en el search se guarda la busqueda de esta
1- Git Clone.\
